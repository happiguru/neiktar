					...
					<div class="row">
						...
						<div class="col-sm-4">
							<br>
								...
								<li>
										<h5>Address</h5>
										<address> United Arab Emirates<br/>PO.BOX 6652, <br/>Sharjah </address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:info@neiktar.com">info@neiktar.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+255 689 938 643">+971 55 202 6183</a>
								</li>
