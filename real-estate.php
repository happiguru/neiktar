...
$cate = $_GET['blog_cat'];
//$blog_tile = $_GET['blog_title'];	
$query1 = "SELECT * FROM tbl_blog WHERE blog_cat = :blog_cat AND blog_title = :blog_title ORDER BY blog_date DESC LIMIT $page1,12";
$query2 = "SELECT * FROM tbl_blog WHERE blog_cat = :blog_cat AND blog_title = :blog_title ORDER BY blog_id DESC";
$fromsearch = true;

$slc_title = "$blog_title";
$slc_category = "$cate";
$title1 = "$slc_category jobs in $slc_title";
}else{
$query1 = "SELECT * FROM tbl_blog ORDER BY blog_id DESC LIMIT $page1,12";
$query2 = "SELECT * FROM tbl_blog ORDER BY blog_id DESC";	
$slc_country = "NULL";
$slc_category = "NULL";	
...
<head>
	...
	<title>Neiktar Jobs - <?php echo "$title"; ?></title>
...
<body class="not-transparent-header">
				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="row">
							...
							<div class="col-sm-4">
								<div class="sorting-header">
									<h3 class="sorting-title"><?php echo "$latpost"; ?></h3>
								</div>
							</div>
					...
					<div class="result-wrapper">
						...
						<div class="row">
							...
							<div class="col-sm-8 col-md-8 mt-25">
								...
								if ($fromsearch == true) {
								$stmt->bindParam(':blog_cat', $slc_category);
                                $stmt->bindParam(':blog_title', $slc_title);	
								}
                                $stmt->execute();
						...
						<div class="job-item-list-info">
							...
							<div class="row">
								...
								<div class="col-sm-12 col-md-12">
									...
									<h4 class="heading"><?php echo $row['blog_title']; ?></h4>
									<div class="meta-div clearfix mb-25">
										<span>published by <a href="blog.php?ref=<?php echo "$bloc_id"; ?>"><?php echo "$author"; ?></a></span>
									</div>
														
									<p class="texing character_limit"><?php echo $row['blog1']; ?></p>
												...
												<div class="row">
													...
													<div class="col-sm-7 col-md-8">
														<div class="sub-category">
															<a><?php echo $row['blog_cat']; ?></a>

														</div>
													</div>
													
													<div class="col-sm-5 col-md-4">
														<a target="_blank" href="explore-blog.php?blogid=<?php echo $row['blog_id']; ?>" class="btn btn-primary">Read More</a>
													</div>
	...
	//   PAGINATION STARTS HERE //
								...
								print '<li class="paging-nav" '; if ($page == "1") { print 'class="disabled"'; } print '><a '; if ($page == "1") { print ''; } else { print 'href="postblog.php?page='.$prevpage.''; ?> <?php if ($fromsearch == true) { print '&blog_cat='.$cate.'&blog_title='.$blog_title.'&search=✓'; }'';} print '"><i class="fa fa-chevron-left"></i></a></li>';
					            for ($b=1;$b<=$records;$b++)
                                 {
                                 
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#33B6CB; color:white" '; } ?>  href="postblog.php?page=<?php echo "$b"; ?><?php if ($fromsearch == true) { print '&blog_cat='.$cate.'&blog_title='.$blog_title.'&search=✓'; }?>"><?php echo $b." "; ?></a></li><?php
                                 }	
								 print '<li class="paging-nav"'; if ($page == $records) { print 'class="disabled"'; } print '><a '; if ($page == $records) { print ''; } else { print 'href="postblog.php?page='.$nextpage.''; ?> <?php if ($fromsearch == true) { print '&blog_cat='.$cate.'&blog_title='.$blog_title.'&search=✓'; }'';} print '"><i class="fa fa-chevron-right"></i></a></li>';
					             }
		...
		<!-- RIGHT SIDE BAR STARTED HERE -->						
								
		<div class="col-sm-4 col-md-4 mt-25">
