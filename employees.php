...
<head>
	...
	<title>Neiktar Jobs - Employees</title>
			...
			<div class="section sm">
				...
				<div class="container">
					...
					<div class="company-grid-wrapper top-company-2-wrapper">
						...
						<div class="GridLex-gap-5-wrappper">
                            ...
                            $stmt = $conn->prepare("SELECT * FROM tbl_users WHERE role = 'employee' ORDER BY first_name LIMIT $page1,12");
                            $stmt->execute();
									...
									<div class="employee-grid-item">
										...
										<a target="_blank" href="employee-detail.php?empid=<?php echo $row['member_no']; ?>" class="clearfix">
											...
											<div class="content">
                                                ...
                                                <h6 class="text-primary">Click to view Profile</h6>
